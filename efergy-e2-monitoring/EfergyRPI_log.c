...
#define VOLTAGE         220/* 240 *//* For non-TPM type sensors, set to line voltage, 
...
#define SAMPLES_TO_FLUSH    30  // Number of samples taken before writing to file.
